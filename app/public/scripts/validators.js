...
module.exports = {
  ...
  isValidISO8601: function(ISO8601) {
  ...
  hasDateAndStartTime: function(appointment) {
  ...
  hasDateStartAndEndTime: function(appointment) {
  ...
  isValidTechId: function(tech_id) {
  ...
  isValidAppointmentType: function(appointment_type) {
  ...
  isTimeOff: function(appointment) {
    if (appointment[0] == '10') {
  ...
  isUnassigned: function(appointment) {
