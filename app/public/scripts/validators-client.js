...
// RE-FORMAT THESE TO BE CLIENT-SIDE (NORMAL LOOKING) FUNCTIONS
// then you can use these to alert user to bad inputs etc

// don't forget to uncomment the script src tag for this file in head.ejs
